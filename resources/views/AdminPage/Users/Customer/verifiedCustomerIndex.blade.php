...
@media(max-width: 1200px){
 ...
 @media(max-width: 490px){
    ...
    <div class="DivTemplate">
        <p class="DivHeaderText center-align">VERIFIED CUSTOMER ACCOUNT MANAGEMENT</p>
        <div class="hr"></div>
    </div>
            ...
            <div class="col-xl-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <p class="data pl-4">@if($user->month != null)  {{$user->month}} {{$user->day}},{{$user->year}} @else N/A @endif</p>
                    </div>
                </div>
            </div>
        </div>
