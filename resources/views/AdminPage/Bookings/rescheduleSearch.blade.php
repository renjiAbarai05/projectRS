...
<div class="container" style="margin-top:-20px;">
        <form class="form-horizontal" id="searchForm" method="POST" action="{{route('booking.searchAvailableRooms')}}">
            ...
            <input type="hidden" value="reschedule" name="searchCategory">
            <div class="DivTemplate" id="searchDiv" style="width:60%; margin-left:21%;">
                <p class="DivHeaderText center-align">SEARCH AVAILABLE ROOMS FOR RESCHEDULE</p>
                <div class="hr"></div>
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            ...
                            <button class="delete-button float-right" type="button" onclick="window.location='{{ route('booking.show',$bookingId) }}'">Cancel</button>
                        </div>
                    </div>
                </div>
        </form>
