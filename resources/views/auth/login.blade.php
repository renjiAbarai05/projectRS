    ...
    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
        ...
        <div class="jumbotron">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="1234" required>
            ...
            <button type="submit" value="Login" onclick="window.location.href='/adminPage'" class="btn btn-lg btn-orange btn-block">Submit</button>
